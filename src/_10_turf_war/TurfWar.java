...
public class TurfWar extends PApplet {
    ...
    public void setup() {
         ...
         */
player1 = new Player(400, 250, 50, 50, Color.BLUE.getRGB(), UP, LEFT, DOWN, RIGHT);
player2 = new Player(100, 250, 50, 50, Color.RED.getRGB(), W, A, S, D);
